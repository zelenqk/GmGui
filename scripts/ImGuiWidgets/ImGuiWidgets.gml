///@desc imguigml wrapper statics for widgets
function ImGuiWidgets() : ImGuiWrapper() constructor{
	#region standard widgets 
	
	///@function button(_label, [_size_x=0], [_size_y=0])
	///@desc ImGui::Button()
	...
	__ImguiIg(invisible_button);
	
	///@function image(_texture_id, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0])
	///@desc ImGui::Image()
	...
	///@function surface(_surface, [width=undefined], [height=undefined], [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0])
	///@desc ImGui::Image()
	...
	///@function sprite(_sprite_index, _sub_img, [_width=undefined], [_height=undefiend], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0])
	///@desc ImGui::Image()
	...
	static sprite = function() {
		...
		push_id(string(sprite) + "_" + string(sub_img));
		__image(texture_id, width, height, u1, v1, u2, v2, tintr, tintg, tintb, tinta, borderr, borderg, borderb, bordera);
		pop_id();
	}
	__ImguiIg(sprite)
	
	///@function image_button(_texture_id, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0])
	...
	__ImguiIg(image_button)
	
	///@function surface_button(_surface, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0])
	...
	///@param {Real} [_tint_a=1.0]         tint color a
	///@returns {Boolean} _pressed
	static surface_button = function() {
		var argi=0,
			surface = argument[argi++],
			width = (argument_count > 1)  ? argument[argi++] : undefined,
			height = (argument_count > 2) ? argument[argi++] : undefined,
	...
	__ImguiIg(surface_button)
	
	///@function sprite_button(_sprite_index, _sub_img, [_width=undefined], [_height=undefiend], [_bg_r=0.0], [_bg_g=0.0], [_bg_b=0.0], [_bg_a=0.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0])
	///@desc ImGui::ImageButton()
	///@param {Real} _sprite_index         sprite
	...
	static sprite_button = function() {
		...
		push_id(string(sprite) + "_" + string(sub_img));
		ret = __image_button(texture_id, width, height, u1, v1, u2, v2, frame_padding, bgr, bgg, bgb, bga, tintr, tintg, tintb, tinta);
		pop_id();
	
		return ret;
	}
	__ImguiIg(sprite_button)
	
	///@function checkbox(_label, _val)
	///@desc ImGui::Checkbox()
	///@param {String}  _label    button label
	///@param {Boolean} _val      checked    
	///@returns {Array: [_changed, _val] } checked
	static checkbox = function() {
		var in = __Imgui_in;
		sr_buffer_write(in, string(argument[0]));                                   
		sr_buffer_write(in, argument[1], ERousrData.Int8);
		
		if (!__imguigml_ext_call(_extImguiGML_checkbox())) return;
	...
	///@function checkbox_flags(_label, _flags, _flag_val)
	...
	__ImguiIg(checkbox_flags)
	
	///@function radio_button(_label, _active, [_current_val])
	...
	static radio_button = function() {
		...
		case 2:
			...
			if (!__imguigml_ext_call(_extImguiGML_radio_button())) return;
			return buffer_read(__Imgui_out, buffer_s8) != 0;
		case 3:
	...
	__ImguiIg(radio_button)
	
	///@function plot_lines(_label, _values, [_values_offset=0], [_overlay=undefined], [_scale_min=undefined], [_scale_max=undefined], [_graph_size_x=0], [_graph_size_y=0], [_stride=sizeof(float)]
	...
	__ImguiIg(plot_lines)
	
	///@function plot_histogram(_label, _values, [_values_offset=0], [_overlay=undefined], [_scale_min=undefined], [_scale_max=undefined], [_graph_size_x=0], [_graph_size_y=0], [_stride=sizeof(float)]
	...
	///@param {Real}   [_graph_size_y=0]
	///@param {Real}   [_stride=sizeof(float)]
	static plot_histogram = function() {
		var in = __Imgui_in;
	...
	__ImguiIg(plot_histogram);
	
	///@function progress_bar(_fraction, [_size_x=-1.0], [_size_y=0.0], [_overlay])
	///@desc
	...
	///@function __image_button(_texture_id, _size_x, _size_y, [_u0=0.0], [_v0=0.0], [_u1=1.0], [_v1=1.0], [_tint_r=1.0], [_tint_g=1.0], [_tint_b=1.0], [_tint_a=1.0], [_border_r=0.0], [_border_g=0.0], [_border_b=0.0], [_border_a=0.0])
	...
	///@returns {Boolean} _pressed
	///@extensionizer { "docs": false }
	static __image_button = function() {
		var in = __Imgui_in;
		...
		if (!__imguigml_ext_call(_extImguiGML_image_button())) return;
	...
	///@function color_edit3(_label, _r_or_array3, [_g=undefined], [_b=undefined], [_flags=0])
	...
	__ImguiIg(color_edit3)
	
	///@function color_edit4(_label, _r_or_array4, [_g=undefined], [_b=undefined], [_a=undefined], [_flags=0])
	///@desc show a color edit field
	///@param {String} _label
	...
	__ImguiIg(color_edit4)
	
	///@function color_picker3(_label, _r_or_array4, [_g=undefined], [_b=undefined], [_flags=0])
	///@desc show a color edit field
	///@param {String} _label
	///@param {Real} _r_or_array4
	///@param {Real} [_g=undefined] 
	...
	__ImguiIg(color_picker3)
	
	///@function color_picker4(_label, _r_or_array4, [_g=undefined], [_b=undefined], [_a=undefined], [_flags=0])
	///@desc show a color edit field
	///@param {String} _label
	///@param {Real} _r_or_array4
	///@param {Real} [_g=undefined] 
	...
	__ImguiIg(color_picker4)
	
	///@function color_button(_desc_id, _r, _g, _b, _a, [_flags=0], [_size_x=0], [_size_y=0])
	...
	__ImguiIg(color_button)
	
	///@function set_color_edit_options
	...
	static set_color_edit_options = function() {
		var in = __Imgui_in;
		sr_buffer_write(in, argument[0], ERousrData.Int32);
		__imguigml_ext_call(_extImguiGML_set_color_edit_options());
	}
	__ImguiIg(set_color_edit_options)
	
	#endregion
	#region combo widgets
	
	///@function combo(_label, _current_item, _items, [_height_in_items = -1]);
	///@desc
	///@param {String} _label
	...
	__ImguiIg(begin_combo)
	///@function end_combo()
	///@desc end a combo widget
	static end_combo = function() {
		__imguigml_ext_call(_extImguiGML_end_combo());
	}
	__ImguiIg(end_combo)
	///@function set_item_default_focus()
	///@desc set the default item focus (temp static until nav update)
	static set_item_default_focus = function() {
		__imguigml_ext_call(_extImGuiGML_set_item_default_focus());
	}
	__ImguiIg(set_item_default_focus)
	
	#endregion
	#region widgets that use dragging for input
	
	///@function drag_float(_label, _v, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"], [_flags=EImGui_SliderFlags.None]);
	...
	__ImguiIg(drag_float)
	
	///@function drag_float2(_label, _v, _v2, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"], [_flags=EImGui_SliderFlags.None]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String}                  _label
	///@param {Real}                    _v
	///@param {Real}                    _v2
	...
	__ImguiIg(drag_float2)
	
	///@function drag_float3(_label, _v, _v2, _v3, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"], [_flags=EImGui_SliderFlags.None]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String}                  _label
	///@param {Real}                    _v
	///@param {Real}                    _v2
	...
	__ImguiIg(drag_float3)
	
	///@function drag_float4(_label, _v, _v2, _v3, _v4, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"], [_flags=EImGui_SliderFlags.None]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String}                  _label
	///@param {Real}                    _v
	///@param {Real}                    _v2
	...
	__ImguiIg(drag_float4)
	
	///@function drag_float_range2(_label, _v_current_min, _v_current_max, [_v_speed=1.0], [_v_min=0], [_v_max=0], [_display_fmt="%.0f"], [_display_fmt_max=undefined], [_flags=EImGui_SliderFlags.None]);
	...
	static drag_float_range2 = function() {
		var in = __Imgui_in;
		sr_buffer_write(in, argument[0]);
		sr_buffer_write(in, argument[1], ERousrData.Float);
		sr_buffer_write(in, argument[2], ERousrData.Float);
	...
	__ImguiIg(drag_float_range2)
	
	///@function drag_int(_label, _v, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String} _label
	///@param {Real}   _v
	///@param {Real}   [_v_speed=1.0]
	...
	///@function drag_int2(_label, _v, _v2, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String} _label
	///@param {Real}   _v
	///@param {Real}   _v2
	...
	///@function drag_int3(_label, _v, _v2, _v3, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String} _label
	///@param {Real}   _v
	///@param {Real}   _v2
	...
	///@function drag_int4(_label, _v, _v2, _v3, _v4, [_v_speed=1.0], [_v_min=0.0], [_v_max=0.0], [_display_format="%.3f"]);
	///@desc  If v_min >= v_max we have no bound
	///@param {String} _label
	///@param {Real}   _v
	///@param {Real}   _v2
	...
	///@function drag_int_range2(_label, _v_current_min, _v_current_max, [_v_speed=1.0], [_v_min=0], [_v_max=0], [_display_fmt="%.0f"], [_display_fmt_max=undefined])
	///@desc drag an integer range 2?
	///@param {String} _label
	///@param {Real}   _v_current_min
	///@param {Real}   _v_current_max
	...
	///@param {String} [_displayFmtMax=undefined]
	///@returns {Array:[_changed, _min, _max]}
	static drag_int_range2 = function() {
		var in = __Imgui_in;
		sr_buffer_write(in, argument[0]);
		sr_buffer_write(in, argument[1], ERousrData.Int32);
		sr_buffer_write(in, argument[2], ERousrData.Int32);
	...
	__ImguiIg(drag_int_range2)
	
	#endregion
	#region widgets that are input (with a keyboard)
	
	///@function input_text(_label, _text, _max_length, [_flags=0], [_callback=undefined], [_user_data=undefined])
	...
	__ImguiIg(input_text)
	
	///@function input_text_multiline(_label, _text, _max_len, _size_x, _size_y, [_flags=0], [_callback=undefined], [_user_data=undefined])
	///@desc add an input text field
	///@param {String} _label
	///@param {String} _text
	///@param {Real} _max_len
	...
	///@param {*} [_userdata=undefined]                 data passed to the callback   
	///@returns {Array:[_changed, _text]}
	static input_text_multiline = function() {
		var in = __Imgui_in;
		sr_buffer_write(in, argument[0]);
		sr_buffer_write(in, argument[1]);
		sr_buffer_write(in, argument[2], ERousrData.Uint32);
	...
	__ImguiIg(input_text_multiline)
	
	///@function input_float(_label, _val, [_step=0.0f], [_step_fast=0.0f], [_decimal_precision=-1], [_extra_flags=0])
	...
	__ImguiIg(input_float)
	
	///@function input_float2(_label, _val, _val2, [_decimal_precision=-1], [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(input_float2)
	
	///@function input_float3(_label, _val, _val2, _val3, [_decimal_precision=-1], [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(input_float3)
	
	///@function input_float4(_label, _val, _val2, _val3, _val4, [_decimal_precision=-1], [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2 
	...
	__ImguiIg(input_float4)
	
	///@function input_int(_label, _val, [_step=1], [_step_fast=100], [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} [_step=1]
	...
	///@function input_int2(_label, _val, _val2, [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(input_int2)
	
	///@function input_int3(_label, _val, _val2, _val3, [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(input_int3)
	
	///@function input_int4(_label, _val, _val2, _val3, _val4, [_extra_flags=0])
	///@desc keyboard input field float
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(input_int4)
	
	#endregion
	#region slider widgets
	
	///@function slider_float(_label, _val, _min, _max, [_display_fmt="%.3f"], [_flags=EImGui_SliderFlags.None]);
	...
	__ImguiIg(slider_float)
	
	///@function slider_float2(_label, _val, _val2, _min, _max, [_display_fmt="%.3f"], [_flags=EImGui_SliderFlags.None]);
	///@desc adjust display_format to decorate the value with a prefix or a suffix for in-slider labels or unit display. 
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(slider_float2)
	
	///@function slider_float3(_label, _val, _val2, _val3, _min, _max, [_display_fmt="%.3f"], [_flags=EImGui_SliderFlags.None])
	///@desc adjust display_format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(slider_float3)
	
	///@function slider_float4(_label, _val, _val2, _val3, _val4, _min, _max, [_display_fmt="%.3f"], [_flags=EImGui_SliderFlags.None])
	///@desc adjust display_format to decorate the value with a prefix or a suffix for in-slider labels or unit display. 
	///@param {String} _label
	///@param {Real} _val
	///@param {Real} _val2
	...
	__ImguiIg(slider_float4)
	
	///@function slider_angle(_label, _rad, [_degree_min=-360.0], [_degree_max=360.0])
	///@desc angle slider
	///@param {String} _label
	///@param {Real} _rad
	...
	__ImguiIg(slider_angle)
	
	///@function slider_int(_label, _v, _v_min, _v_max, [_display_fmt="%.0f"])
	...
	__ImguiIg(slider_int)
	
	///@function slider_int2(_label, _v, _v2, _v_min, _v_max, [_display_fmt="%.0f"])
	///@desc add an integer slider
	///@param {String} _label
	///@param {Real} _v
	///@param {Real} _v2
	...
	__ImguiIg(slider_int2)
	
	///@function slider_int3(_label, _v, _v2, _v3, _v_min, _v_max, [_display_fmt="%.0f"])
	///@desc add an integer slider
	///@param {String} _label
	///@param {Real} _v
	///@param {Real} _v2
	...
	__ImguiIg(slider_int3)
	
	///@function slider_int4(_label, _v, _v2, _v3, _v4, _v_min, _v_max, [_display_fmt="%.0f"])
	///@desc add an integer slider
	///@param {String} _label
	///@param {Real} _v
	///@param {Real} _v2
	...
	__ImguiIg(slider_int4)
	
	///@function vslider_float(_label, _size_x, _size_y,  _v, _v_min, _v_max, [_display_fmt="%.0f"], [_flags=EImGui_SliderFlags.None])
	...
	__ImguiIg(vslider_float)
	
	///@function vslider_int(_label, _size_x, _size_y,  _v, _v_min, _v_max, [_display_fmt="%.0f"])
	///@desc a vslider int?
	///@param {String} _label
	///@param {Real} _size_x
	///@param {Real} _size_y
	...
	///@function text_colored(_r, _g, _b, _a, _text)
	...
	__ImguiIg(text_colored)
	
	///@function text_disabled(_text)
	///@desc shortcut for PushStyleColor(ImGuiCol_Text, style.Colors[ImGuiCol_TextDisabled]); Text(fmt, ...); PopStyleColor();
	///@param {String} _text
	static text_disabled = function() {
		var buff = __imguigml_wrapper_buffer();
		sr_buffer_write(buff, string(argument[0]));
		__imguigml_ext_call(_extImguiGML_text_disabled());
	}
	__ImguiIg(text_disabled)
	
	///@function text_wrapped(_text)
	///@desc shortcut for `push_text_wrap_pos(0.0f); text(_text); pop_text_wrap_pos();`. 
	///@param {String} _text
	///@Note: this won't work on an auto-resizing window if there's no other widgets to 
	static text_wrapped = function() {
		//         extend the window width, you may need to set a size using `set_next_window_size()`
		var buff = __imguigml_wrapper_buffer();
		sr_buffer_write(buff, string(argument[0]));
		__imguigml_ext_call(_extImguiGML_text_wrapped());
	}
	__ImguiIg(text_wrapped)
	
	///@function label_text(_label, _text)
	///@desc display text+label aligned the same way as value+label widgets
	///@param {String} _label
	///@param {String} _text
	static label_text = function() {
		var buff = __imguigml_wrapper_buffer();
		sr_buffer_write(buff, string(argument[0]));
		sr_buffer_write(buff, string(argument[1]));
		__imguigml_ext_call(_extImguiGML_label_text());
	}
	__ImguiIg(label_text)
	
	///@function bullet_text(_text)
	///@desc shortcut for Bullet()+Text()
	///@param {String} _text
	static bullet_text = function() {
		var buff = __imguigml_wrapper_buffer();
		sr_buffer_write(buff, string(argument[0]));
		__imguigml_ext_call(_extImguiGML_bullet_text());
	}
	__ImguiIg(bullet_text)
	...
	///@function tree_node_ex(_labelOrId, [_flags=0])
	///@desc begin a tree node
	///@param {String|Real}               _labelOrId   a label or id to use - used as id if passed real
	///@param {Real:EImGui_TreeNodeFlags} [_flags=0]
	///@returns {Boolean} if returning 'true' the node is open and the tree id is pushed into the id stack. user is responsible for calling TreePop().
	static tree_node_ex = function() {
		var in = __Imgui_in;
		var _id = argument[0];
	...
	///@function tree_pop()
	///@desc ~ Unindent()+PopId()
	static tree_pop = function() {
		__imguigml_ext_call(_extImguiGML_tree_pop());
	}
	__ImguiIg(tree_pop)
	
	///@function tree_advance_to_label_pos
	///@desc advance cursor x position by GetTreeNodeToLabelSpacing()
	static tree_advance_to_label_pos = function() {
		__imguigml_ext_call(_extImguiGML_tree_advance_to_label_pos());
	}
	__ImguiIg(tree_advance_to_label_pos)
	
	///@function get_tree_node_to_label_spacing()
	...
	__ImguiIg(set_next_tree_node_open)
	
	///@function collapsing_header(_label, [_p_open=undefined], [_flags=0])
	...
	static collapsing_header = function() {
		var in = __Imgui_in;
		var _label = argument[0];
